...
export const estatuto: Estatuto = {
  titulo:
    "Estatuto de la Asociación Civil de Docentes de Matemática de Facultades de Ciencias Económicas y Afines",
  titulos: [
    {
      numero: "I",
      nombre: "Denominación, Domicilio, Objeto Social, Actividades y Fines",
      articulos: [
        {
          numero: 1,
          subtitulo: "DENOMINACIÓN",
          contenido:
            'Bajo la denominación de "Asociación Civil de Docentes de Matemática de Facultades de Ciencias Económicas y Afines" se constituye una asociación civil sin fines de lucro de carácter académico, técnico y científico, que continuará la obra realizada por un grupo de docentes que la iniciaron bajo el nombre de "Asociación de Docentes de Matemática de Facultades de Ciencias Económicas y Afines", desde el 26 de octubre del año 1986.',
        },
        {
          numero: 2,
          subtitulo: "DOMICILIO",
          contenido:
            "Constituye su domicilio en la Ciudad de Rosario, Provincia de Santa Fe.",
        },
        {
          numero: 3,
          subtitulo: "OBJETO",
          contenido:
            "La Asociación tiene por objeto fomentar, promover, desarrollar y difundir el conocimiento académico, técnico, científico y de la enseñanza, en el campo de la Matemática, sus aplicaciones y disciplinas conexas.",
        },
        {
          numero: 4,
          subtitulo: "ACTIVIDADES Y FINES",
          contenido: [
            "Para lograr su objeto podrá realizar las siguientes actividades y perseguir los siguientes fines:",
            "a) efectuar un constante intercambio de ideas, de trabajos de investigación, reuniones y publicaciones periódicas;",
            "b) agrupar y vincular entre sí a todas las personas e instituciones relacionadas con la Matemática y sus aplicaciones, para que con el trato frecuente y el análisis común se enriquezca la vocación compartida;",
            "c) fomentar y estrechar vínculos de unión y camaradería entre todos sus asociados;",
            "d) estudiar e investigar técnicas de enseñanza empleadas en el país y en el extranjero;",
            "e) ofrecer colaboración y asesoramiento a organismos oficiales sean nacionales, provinciales o municipales, u organismos internacionales o comunitarios con sede o representación en Argentina;",
            "f) organizar y participar en jornadas, simposios, congresos, cursos, mesas redondas y actividades análogas sobre temas de Matemática y sus disciplinas conexas e interdisciplinarias de estas Facultades;",
            "g) organizar y participar en becas, premios, concursos, publicaciones y otros medios adecuados sobre temas de Matemática y sus disciplinas conexas e interdisciplinarias de estas Facultades;",
            "h) intercambiar publicaciones y mantener relaciones con instituciones afines, nacionales, extranjeras, internacionales o comunitarias. En el ejercicio de estas actividades y en el cumplimiento de su objeto podrá realizar todos los demás actos que no le hayan sido expresamente prohibidos por este Estatuto y por las leyes de la República Argentina y que no sean contrarios a la moral y las buenas costumbres.",
          ],
        },
      ],
    },
    {
      numero: "II",
      nombre: "Capacidad, Patrimonio y Recursos Sociales",
      articulos: [
        {
          numero: 5,
          subtitulo: "CAPACIDAD",
          contenido:
            "La Asociación podrá adquirir toda clase de bienes muebles, bienes inmuebles, automotores, por cualquier titulo que fuere, contraer obligaciones, y celebrar todos aquellos actos que hagan al logro de sus fines así como operar con entidades financieras públicas o privadas, debidamente autorizadas, todo conforme a las leyes de la República Argentina y a las normas de este Estatuto.",
        },
        {
          numero: 6,
          subtitulo: "PATRIMONIO Y RECURSOS SOCIALES",
          contenido: [
            ...
            "c) las donaciones, herencias, legados y subvenciones o subsidios;",
    ...
    },
    {
      ...
      articulos: [
        ...
        },
        {
          ...
          subtitulo: "ADMISIÓN",
          contenido:
            "Para ser admitido como asociado activo, adherente o institucional, el postulante deberá presentar una solicitud ante el Consejo Directivo.",
        },
        {
          numero: 10,
          subtitulo: "DERECHOS Y OBLIGACIONES DE LOS ASOCIADOS",
          contenido: [
    ...
    },
    {
      numero: "IV",
      nombre:
        "Del Consejo Directivo y la Sindicatura — Disposiciones Generales, Elecciones y Disposiciones Especiales",
      articulos: [
        {
          numero: 15,
          subtitulo: "DISPOSICIONES GENERALES",
          contenido:
            "La Asociación será dirigida y administrada por un Consejo Directivo compuesto de nueve miembros titulares asociados activos que desempeñarán los siguientes cargos: Presidente, Vicepresidente, Secretario, Pro Secretario, Tesorero, Pro Tesorero y tres Vocales. Habrá además tres vocales suplentes elegidos asimismo entre los asociados activos. El mandato de los miembros, tanto titulares como suplentes, será de dos años y podrán ser reelegidos. En todos los casos, sus mandatos son únicamente revocables por la Asamblea, con expresión de causa y con decisión fundada. Todos los cargos tienen carácter personal e indelegable, y son todos «ad honorem», no pudiendo percibir sueldo o remuneración alguna por el desempeño de los mismos.",
        },
        {
          numero: 16,
          contenido:
            "La fiscalización estará a cargo de un Síndico titular, que deberá ser asociado activo. Se elegirá un síndico suplente, que también deberá ser asociado activo. El mandato de los mismos durará dos años y podrán ser reelegidos.",
        },
        {
          numero: 17,
          contenido:
            "Para integrar el Consejo Directivo se requiere pertenecer a la categoría de asociado activo, estar al día con la tesorería y no tener antecedentes disciplinarios en esta Asociación, ni antecedentes disciplinarios en los Colegios Profesionales en su caso, durante los cinco años anteriores a los comicios. Todos los cargos son personales e indelegables, y son «ad honorem», no pudiendo recibir ni sueldo ni remuneración alguna por el ejercicio de sus funciones.",
        },
        {
          numero: 18,
          subtitulo: "DE LAS ELECCIONES",
          contenido:
            "Para la elección de los miembros titulares y suplentes del Consejo Directivo, del Sindico Titular y del Sindico Suplente se convocará a comicios que se celebrarán durante la Asamblea Ordinaria.",
        },
        {
          numero: 19,
          contenido:
            "Tendrán derecho a voto para la elección de autoridades los asociados activos que estén al día con tesorería y que tengan dos años de antigüedad continua como mínimo. Cada asociado mencionado precedentemente tendrá un voto. Podrá otorgarse mandato escrito a otro asociado activo para concurrir a la asamblea y para votar, siendo suficiente una esquela, nota y/o carta con la firma certificada por autoridad policial, o por un banco, o por una autoridad judicial. No se podrá representar a más de un asociado. La votación se realizará por lista completa. Las listas deberán presentarse al Consejo Directivo con una anticipación de quince días al de la celebración de la Asamblea en la que se realizarán los comicios. La presentación de la lista deberá estar firmada por diez asociados activos, entre ellos tres de los candidatos. Los candidatos deberán enviar su aceptación a integrar la lista por carta o correo electrónico. Sobre la base de las listas presentadas y aceptadas, el Consejo Directivo con siete días de anticipación a la fecha de los comicios, procederá a hacer públicas las listas.",
        },
        {
          numero: 20,
          contenido:
            "El voto será secreto. Los asociados habilitados deberán depositar el voto en una urna dispuesta al efecto durante el acto electoral.",
        },
        {
          numero: 21,
          contenido:
            "El padrón electoral se formará con los asociados activos habilitados según el artículo 19º. Deberá constar en el mismo los siguientes datos: apellido y nombre, documento de identidad (clase y número), domicilio, fecha de ingreso, estado actual de pago de las cuotas y contribuciones y, en su caso, los datos del mandato.",
        },
        {
          numero: 22,
          contenido:
        ...
        },
        {
          numero: 23,
          contenido:
            "Finalizados los comicios, la Junta Electoral procederá al escrutinio y resultará electa la lista de candidatos que obtenga mayor cantidad de votos válidos. En caso de empate votarán nuevamente los miembros del Consejo Directivo que estén presentes en la Asamblea y si subsistiera el empate, decidirá el Presidente de la Asamblea. Decidida la elección, la Junta Electoral procederá a proclamar a los candidatos electos, los que asumirán su mandato, el día que se haya fijado en la convocatoria a elecciones. En el caso de haberse presentado una sola lista la Asamblea la proclamará en forma automática.",
        },
        {
          numero: 24,
          contenido:
            "El Consejo Directivo arbitrará los medios para que la elección del nuevo Consejo Directivo y Sindicatura se efectúe coincidiendo con la realización de las Jornadas Anuales. En caso de que no se realizaran las Jornadas en el año que corresponde a la elección queda prorrogado automáticamente el mandato del Consejo Directivo y de la Sindicatura hasta la fecha de realizarse la siguiente Jornada Anual.",
        },
        {
          numero: 25,
          subtitulo: "DISPOSICIONES ESPECIALES — CONSEJO DIRECTIVO",
          contenido: [
            "En caso de licencia, renuncia, fallecimiento o cualquier otra causa que ocasione la vacancia transitoria o permanente de un cargo titular ya sea en el Consejo Directivo o en la Sindicatura, se procederá de la siguiente manera:",
            "a) al Presidente lo reemplaza el Vicepresidente,",
            "b) al Vicepresidente el Secretario,",
            "c) al Secretario el Pro Secretario,",
            "d) al Tesorero el Pro Tesorero,",
            "e) al Vicepresidente, al Pro Secretario y al Pro Tesorero los Vocales titulares en el orden de su elección,",
            "f) las vacancias correspondientes a los Vocales titulares, por los Vocales suplentes, siguiendo el mismo criterio,",
            "g) en caso de vacancia del Síndico Titular, éste será reemplazado por el Síndico suplente. Todo reemplazo se hará por el término de la vacancia y siempre que no exceda el término del mandato del que fuera elegido el reemplazante.",
          ],
        },
        {
          numero: 26,
        ...
        },
        {
          ...
          contenido: [
            ...
            "c) Nombrar al personal necesario para el cumplimiento de sus funciones, fijarles el sueldo, determinar sus obligaciones y en su caso contratar servicios de cualquier naturaleza profesionales o no, que no estén en relación de dependencia.",
        ...
        {
          numero: 37,
          subtitulo: "SINDICATURA",
          contenido: [
            "El Sindico Titular tendrá las siguientes atribuciones y deberes:",
      ...
      articulos: [
        {
          ...
          contenido: [
            ...
            "b) Considerar y aprobar o rechazar la gestión del Consejo Directivo.",
            "c) Tratar solamente todo asunto incluido en el Orden del Día.",
